...
import 'package:mutoni/Widget/bezierContainer.dart';
    ...
    return GestureDetector(
      onTap: (){
        if(emailController.text.isEmpty || passwordController.text.isEmpty || nameController.text.isEmpty){
          ...
          .signUp(email: emailController.text, password: passwordController.text, name: nameController.text, image: 'image')
          .then((result) {
              if (result == null) {
